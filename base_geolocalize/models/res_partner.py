...
class res_partner(osv.osv):
    ...
    #CAMPOS AGREGADOS PARA KDOCE 
        'sostenedor': fields.char('Sostenedor'),
        'id_region': fields.many2one('res.country.state','Region', select=True, ondelete='cascade'),
        'matricula': fields.char('Matricula', select=1),
        'alumnos_sep_matricula': fields.integer('Alumnos SEP Matricula', select=1),
        'alumnos_sep': fields.integer('Alumnos SEP', select=1),
